...
async def upload_and_analyze(
    ...
    return {
        ...
        "inspection_code": code,
        "disease": disease,
        "disease_name": ai_result.get("disease_name", disease),
        "disease_type": ai_result.get("disease_type", "Crop Pathology"),
        "disease_info": ai_result.get("disease_info", ""),
        "prevention_treatment": ai_result.get("prevention_treatment", ""),
        "confidence": confidence,
        "description": description,
        "recommended_action": recommended_action,
        "treatment_authorized": authorized,
